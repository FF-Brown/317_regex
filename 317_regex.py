...
"00:10:48	Student Name:	vague: something",
"00:17:44	John Doe:	Sorry I just got back to my desk. What was the warmup question (if there was one)",
...
for line in lines:
    print(x, ".) ", line, sep="")
    x = x +1
    extracted = re.findall("^[0-9]{2}:[0-9]{2}:[0-9]{2}[\s]*.*:[\s]*(.*)$", line)
    # Add try-catch here.
    print(extracted[0])
